...
void UpmixerComponents::sliderValueChanged (Slider* sliderThatWasMoved)
{
    ...
    else if (sliderThatWasMoved == cutoffSliderC)
    {
        ...
        ADI_REG_TYPE writeData[4] = {0};
        SIGMA_USER_TO_FIXPOINT_CONVERT( coeffs.coefficients[0], writeData );
        SIGMA_WRITE_REGISTER_BLOCK(DEVICE_ADDR_IC_1, MOD_CFILTER_ALG0_STAGE0_B0_ADDR, 4, SIGMASTUDIOTYPE_8_24_CONVERT(coeffs.coefficients[0]));
        SIGMA_WRITE_REGISTER_BLOCK(DEVICE_ADDR_IC_1, MOD_CFILTER_ALG0_STAGE1_B0_ADDR, 4, SIGMASTUDIOTYPE_8_24_CONVERT(coeffs.coefficients[0]));
        SIGMA_WRITE_REGISTER_BLOCK(DEVICE_ADDR_IC_1, MOD_CFILTER_ALG0_STAGE2_B0_ADDR, 4, SIGMASTUDIOTYPE_8_24_CONVERT(coeffs.coefficients[0]));
        SIGMA_USER_TO_FIXPOINT_CONVERT( coeffs.coefficients[1], writeData );
        SIGMA_WRITE_REGISTER_BLOCK(DEVICE_ADDR_IC_1, MOD_CFILTER_ALG0_STAGE0_B1_ADDR, 4, SIGMASTUDIOTYPE_8_24_CONVERT(coeffs.coefficients[1]));
        SIGMA_WRITE_REGISTER_BLOCK(DEVICE_ADDR_IC_1, MOD_CFILTER_ALG0_STAGE1_B1_ADDR, 4, SIGMASTUDIOTYPE_8_24_CONVERT(coeffs.coefficients[1]));
        SIGMA_WRITE_REGISTER_BLOCK(DEVICE_ADDR_IC_1, MOD_CFILTER_ALG0_STAGE2_B1_ADDR, 4, SIGMASTUDIOTYPE_8_24_CONVERT(coeffs.coefficients[1]));
        SIGMA_USER_TO_FIXPOINT_CONVERT( coeffs.coefficients[2], writeData );
        SIGMA_WRITE_REGISTER_BLOCK(DEVICE_ADDR_IC_1, MOD_CFILTER_ALG0_STAGE0_B2_ADDR, 4, SIGMASTUDIOTYPE_8_24_CONVERT(coeffs.coefficients[2]));
        SIGMA_WRITE_REGISTER_BLOCK(DEVICE_ADDR_IC_1, MOD_CFILTER_ALG0_STAGE1_B2_ADDR, 4, SIGMASTUDIOTYPE_8_24_CONVERT(coeffs.coefficients[2]));
        SIGMA_WRITE_REGISTER_BLOCK(DEVICE_ADDR_IC_1, MOD_CFILTER_ALG0_STAGE2_B2_ADDR, 4, SIGMASTUDIOTYPE_8_24_CONVERT(coeffs.coefficients[2]));
        SIGMA_USER_TO_FIXPOINT_CONVERT( coeffs.coefficients[3], writeData );
        SIGMA_WRITE_REGISTER_BLOCK(DEVICE_ADDR_IC_1, MOD_CFILTER_ALG0_STAGE0_A1_ADDR, 4, SIGMASTUDIOTYPE_8_24_CONVERT(coeffs.coefficients[3]));
        SIGMA_WRITE_REGISTER_BLOCK(DEVICE_ADDR_IC_1, MOD_CFILTER_ALG0_STAGE1_A1_ADDR, 4, SIGMASTUDIOTYPE_8_24_CONVERT(coeffs.coefficients[3]));
        SIGMA_WRITE_REGISTER_BLOCK(DEVICE_ADDR_IC_1, MOD_CFILTER_ALG0_STAGE2_A1_ADDR, 4, SIGMASTUDIOTYPE_8_24_CONVERT(coeffs.coefficients[3]));
        SIGMA_USER_TO_FIXPOINT_CONVERT( coeffs.coefficients[4], writeData );
        SIGMA_WRITE_REGISTER_BLOCK(DEVICE_ADDR_IC_1, MOD_CFILTER_ALG0_STAGE0_A2_ADDR, 4, SIGMASTUDIOTYPE_8_24_CONVERT(coeffs.coefficients[4]));
        SIGMA_WRITE_REGISTER_BLOCK(DEVICE_ADDR_IC_1, MOD_CFILTER_ALG0_STAGE1_A2_ADDR, 4, SIGMASTUDIOTYPE_8_24_CONVERT(coeffs.coefficients[4]));
        SIGMA_WRITE_REGISTER_BLOCK(DEVICE_ADDR_IC_1, MOD_CFILTER_ALG0_STAGE2_A2_ADDR, 4, SIGMASTUDIOTYPE_8_24_CONVERT(coeffs.coefficients[4]));
    }
